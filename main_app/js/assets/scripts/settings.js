var current_step = 1,token="",qr_code=null,copied = null,copy_timeout = null;
...
function verify_mail(){
    $.ajax({
        ...
        type: "POST",
        contentType: "application/json",
        data: JSON.stringify({"code":document.getElementById('email_code').value}),
        success: function(data){
            console.log(data);
        }
    })
...
function verify_phone(){
    $.ajax({
        ...
        type: "POST",
        contentType: "application/json",
        data: JSON.stringify({"code":document.getElementById('phone_code').value}),
        success: function(data){
            console.log(data);
        }
    })
