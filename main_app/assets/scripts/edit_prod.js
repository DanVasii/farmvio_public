...
$(document).ready(function(){
    ...
    $(".wpoints").on("change","input",function(){
        ...
        {
            if ($(this).parent().find(".point_name").text().trim()!=""){
    ...
    $.ajax({
        ...
        success: function(data){
            if (typeof data == "object"){
                console.log(data);
                document.getElementById("prod_name").value = data.product_name_real;
                document.getElementById("desc").value = data.description;
                document.getElementById("price").value = data.price;
                document.getElementById("prod_title").value = data.name;
                ...
                for (index in points){
                    if($("#"+points[index]).parent().find(".point_name").text().trim()!=""){
...
function update_data(){
    ...
    final_data.prod_title = document.getElementById("prod_title").value;
